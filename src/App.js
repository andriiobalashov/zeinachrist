...
import logo from './media/logo/logo-blanc.png'
import border from './media/textures/border.svg'
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav">
                    <a class="nav-item nav-link" href="#first-section">À propos</a>
              ...
              <div class="row center-container">
                  <div class="col-lg-7">
                    <div class="hero-text-section">
                        <h1 class="title-1">Agence <label class="hero-word">Créative<img class="border-image" src={border} alt="" /></label> <br/>
                          & Social Média
                        </h1>
                  ...
                  <div class="col-lg-5">
                    <div class="content-asolutly-center">
                        <div class="hero-mockup">
                          <img src="media/textures/vector.png" class="mockup-bg" alt=""/>
                          <img src="media/textures/mockup.png" class="mockup" alt=""/>
                          <img src="media/textures/sparkle.png" class="mockup-star-top" alt=""/>
                          <img src="media/textures/sparkle.png" class="mockup-star-bottom" alt=""/>
                        </div>
                    </div>
                  </div>
              </div>
            ...
            <div class="first-section-container">
              ...
              <div class="about-text-image-section">
                  <div class="image-container">
                    <img src="media/2-a-propos/about-zeina.png" class="about-zeina-img" alt=""/>
                    <img src="media/textures/sparkles.svg" class="about-star-top" alt=""/>
                    <img src="media/textures/sparkles.svg" class="about-star-bottom" alt=""/>
                  </div>
            ...
            <div class="container">
              <div class="second-show-default">
                  <h2 class="second-section-title">
                    Les 
                    <div class="services-span">services</div>
                    que je propose
                  </h2>
                    ...
                    <div class="col-lg-6">
                        <div class="service-card">
                          <div class="service-card-bg service-top-left">
                              <img src="/media/3-services/icon-1.png" class="service-card-icon" alt=""/>
                    ...
                    <div class="col-lg-6">
                        <div class="service-card">
                          <div class="service-card-bg service-top-right">
                              <img src="/media/3-services/icon-2.png" class="service-card-icon" alt=""/>
                    ...
                    <div class="col-lg-6">
                        <div class="service-card">
                          <div class="service-card-bg service-bottom-left">
                              <img src="/media/3-services/icon-3.png" class="service-card-icon" alt=""/>
                    ...
                    <div class="col-lg-6">
                        <div class="service-card">
                          <div class="service-card-bg service-bottom-right">
                              <img src="/media/3-services/icon-4.png" class="service-card-icon" alt=""/>
              ...
              <div class="second-hidden-default none">
                  <div class="second-nav">
                    ...
                    <img src="media/textures/arrow-red.svg" alt=""/>
                    </button>
                          ...
                          <div class="second-left-container">
                              <div class="service-info-1">
                                ...
                                <div class="service-content">
                                    <img class="service-icon-1" src="/media/textures/zeina-bitmoji contour-blanc.png" alt=""/>
                                    <p class="service-paragraph">Faire des stories engageantes, créer des visuels avec un petit budget ou utiliser les bons hashtags ? <br/>
                                      Le temps d'une pause déjeuner, je réponds à toutes tes questions et te partage des astuces et recommandations sur mesure pour t'aider à gérer tes réseaux sociaux ou créer du contenu qualitatif comme une boss !
                                    </p>
                                </div>
                              </div>
                          </div>
                        ...
                        <div class="col-lg-6">
                          <div class="second-right-container">
                              <div class="service-info-2">
                                ...
                                <div class="service-content">
                                    <img class="service-icon-1" src="/media/textures/zeina-bitmoji-contour-lila.png" alt=""/>
                                    <div>
                                      <img src="/media/textures/star.png" class="star-icon" alt=""/>
        ...
        <section class="case-stadies" id="case-stadies">
            <div class="case-stadie-container">
              <div class="label-container">
                  <div class="case-study-label">Case studies</div>
              </div>
                  ...
                  <div class="swiper-wrapper">
                        ...
                        <div class="slider-container">
                          <div class="row">
                              <div class="col-lg-5 img-slide-container">
                                <img src="/media/textures/case-study-1.png" class="case-study-img" alt=""/>
                                <div class="second-buttom-container">
                                    <a href="https://calendly.com/zeinachrist-co" target="_blank" class="button-standart-light second-button">Je me lance</a>
                                </div>
                              </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slider-container">
                          <div class="row">
                              <div class="col-lg-5 img-slide-container">
                                <img src="/media/textures/case-study-2.png" class="case-study-img" alt=""/>
                                <div class="second-buttom-container">
                                    <a href="https://calendly.com/zeinachrist-co" target="_blank" class="button-standart-light second-button">Je me lance</a>
                                </div>
                              </div>
                              <div class="col-lg-7">
                                <div>
                                    ...
                                    <h2 class="slide-h-second">Résultats</h2>
                                    <img src="/media/textures/case-study-2-2.png" class="slide-second-img" alt=""/>
                                </div>
                              </div>
                          </div>
                        </div>
                              ...
                              <div class="col-lg-5 img-slide-container">
                                <div class="img-video-container">
                                    <video width="100%" height="auto" controls autoplay>
                                      <source src="/media/textures/video1.mp4" type="video/mp4" />
        ...
        <section class="feedbacks" id="feedbacks">
            <div class="container feedback-container">
              <div class="full-w">
                  ...
                  <img src="/media/textures/fleche-feedback.png" class="feedback-arrow" alt=""/>
                  <div class="container-img">
                    <div class="row">
                        <div class="col-lg-6">
                          <img src="/media/5-feedbacks /screens-feedbacks/1.jpeg" class="feedback-img" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/3.jpg" class="feedback-img" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/6.jpeg" class="feedback-img" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/9.jpeg" id="feedback-img-hide-1" class="feedback-img none" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/12.jpeg" id="feedback-img-hide-2" class="feedback-img none" alt=""/>
                        </div>
                        <div class="col-lg-6">
                          <img src="/media/5-feedbacks /screens-feedbacks/2.jpeg" class="feedback-img" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/4.jpeg" class="feedback-img" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/5.jpeg" class="feedback-img" alt=""/>                
                          <img src="/media/5-feedbacks /screens-feedbacks/7.jpeg" class="feedback-img" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/8.jpeg" class="feedback-img" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/6.jpeg" id="feedback-img-hide-3" class="feedback-img none" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/14.jpeg" id="feedback-img-hide-4"class="feedback-img none" alt=""/>
                          <img src="/media/5-feedbacks /screens-feedbacks/15.jpeg" id="feedback-img-hide-5" class="feedback-img none" alt=""/>
                        </div>
                    </div>
                    <button id="feedback-more-button" class="feedback-more-button"><img src="/media/textures/arrow-down.svg" alt=""/></button>
                    <div class="second-buttom-container">
                        <a href="https://calendly.com/zeinachrist-co" target="_blank" class="button-standart-light second-button">Je me lance</a>
                    </div>
                  </div>
        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-2 center">
                  <img src="/media/logo/logo.png" class="footer-logo" alt=""/>
              </div>
              <div class="col-lg-5">
                  <div>
                    <h2 class="footer-h">Zeina Christ & co</h2>
                    <div class="footer-nav">
                        <a href="" class="footer-nav-link">À propos</a>
                  ...
                  <div>
                    ...
                    <div class="footer-social">
                        <a href="" class="footer-social-link">
                          <img src="/media/textures/whatsapp.svg" alt=""/>
                          <p class="footer-social-p">WhatsApp</p>
                        </a>
                        <a href="" class="footer-social-link">
                          <img src="/media/textures/mail.svg" alt=""/>
                          <p class="footer-social-p">Mail</p>
                        </a>
                        <a href="" class="footer-social-link">
                          <img src="/media/textures/intagram.svg" alt=""/>
                          <p class="footer-social-p">Instagram</p>
                        </a>
                        <a href="" class="footer-social-link">
                          <img src="/media/textures/cloubhouse.svg" alt=""/>
                          <p class="footer-social-p">Clubhouse</p>
                        </a>
                        <a href="" class="footer-social-link">
                          <img src="/media/textures/linkedin.svg" alt=""/>
